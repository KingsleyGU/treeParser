	...
	#################
qa = {
	r'(terry bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>terry bypases authentication in VirtualMachine</label>' +
	...
	r'(administrator finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>administrator finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(administrator mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>administrator mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">0</parameter>' +
		'<parameter name="likelihood" class="ordinal">V</parameter>' +
		'<parameter name="difficulty" class="ordinal">L</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(ethan escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>ethan escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(terry mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>terry mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(cleo bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>cleo bypases authentication in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">M</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(administrators bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>administrators bypases authentication in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">M</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(grey mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>grey mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(administrator bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>administrator bypases authentication in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">M</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(administrators mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>administrators mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">0</parameter>' +
		'<parameter name="likelihood" class="ordinal">V</parameter>' +
		'<parameter name="difficulty" class="ordinal">L</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(finn bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>finn bypases authentication in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">M</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(administrators escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>administrators escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(grey bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>grey bypases authentication in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">M</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(administrator escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>administrator escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(big bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>big bypases authentication in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">M</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(sydney mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>sydney mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">0</parameter>' +
		'<parameter name="likelihood" class="ordinal">V</parameter>' +
		'<parameter name="difficulty" class="ordinal">L</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(grey escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>grey escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(terry finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>terry finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(ethan finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>ethan finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(finn finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>finn finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(grey finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>grey finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(cleo mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>cleo mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(administrators finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>administrators finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(finn mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>finn mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(cleo escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>cleo escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(ethan mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>ethan mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(big mounts the HD of VirtualMachine and inspects it)':
	'<node refinement="disjunctive">' +
		'<label>big mounts the HD of VirtualMachine and inspects it</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(sydney finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>sydney finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">0</parameter>' +
		'<parameter name="likelihood" class="ordinal">V</parameter>' +
		'<parameter name="difficulty" class="ordinal">L</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(big escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>big escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(cleo finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>cleo finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(big finds fileX in the file system of VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>big finds fileX in the file system of VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(terry escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>terry escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(ethan bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>ethan bypases authentication in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">M</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(sydney bypases authentication in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>sydney bypases authentication in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">M</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(sydney escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>sydney escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">0</parameter>' +
		'<parameter name="likelihood" class="ordinal">V</parameter>' +
		'<parameter name="difficulty" class="ordinal">L</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
	...
	r'(finn escalates privileges in VirtualMachine)':
	'<node refinement="disjunctive">' +
		'<label>finn escalates privileges in VirtualMachine</label>' +
		'<parameter name="cost" class="numeric">500</parameter>' +
		'<parameter name="likelihood" class="ordinal">L</parameter>' +
		'<parameter name="difficulty" class="ordinal">H</parameter>' +
		'<parameter name="time" class="ordinal">MT</parameter>' +
