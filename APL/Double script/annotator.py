...
from util2 import    	log, closeLogging, getFirstChildElement, \
...
#        outputFile = '{0}_fixed_faketree{1}'.format(path[:path.rindex('.')],path[-4:])
...
scenario = scenario = '../../ATA/Cloud Complex/ANM-generated_TREsPASS_model_combined_refined.xml'
